...
                /* --- MODAL DE CRITERIOS (MEJORAS DE DISEÑO) --- */
...
                }
                ...
                /* MEJORA 1: Botones de Bimestre en Modal */
                .grupo-componente .modal-content .bimestre-selector .btn {
                    padding: 0.6rem 1.2rem; /* Menos padding para hacerlo más compacto y formal */
                    font-weight: 600;
                ...
                .grupo-componente .modal-content .bimestre-selector .btn-primary {
                    ...
                    color: var(--dark-color);
                    border-color: var(--main-color);
                    box-shadow: 0 0 5px rgba(185, 151, 43, 0.5); /* Sombra para resaltar */
                }
                
                /* MEJORA 2: Botón de Copiar */
                .grupo-componente .btn-secondary {
                    background-color: #3C414C; /* Tono de botón más neutral */
                    border-color: #555;
                    font-size: 0.95rem;
                }
                .grupo-componente .btn-secondary:hover {
...
                    height: 30px;
                    font-size: 1.5rem;
                    background: none; /* Mejoramos la visibilidad del botón de eliminar */
                    border: none;
                    cursor: pointer;
                    line-height: 1;
                }
...
                
                /* MEJORA 3: Formulario de adición de criterios más formal */
                .grupo-componente .criterio-form {
                    display: flex;
                    gap: 15px; /* Aumentamos ligeramente el espacio */
                    margin: 2rem 0 1rem 0;
                    align-items: center;
                }
                .grupo-componente .criterio-form input {
                    background: var(--dark-color);
                    border: 1px solid #555; /* Borde más fino para formalidad */
                    border-radius: 6px; /* Borde menos agresivo */
                    color: var(--text-color);
                    padding: 12px 12px; /* Ajuste de padding */
                    box-sizing: border-box;
                    font-size: 1rem;
                    font-weight: 400; /* Fuente más ligera para inputs */
                }
                .grupo-componente .criterio-form input[type="text"] {
                    flex-grow: 2; /* Permite que el nombre ocupe más espacio */
                }
                .grupo-componente .criterio-form input:focus {
                    border-color: var(--main-color);
                    box-shadow: 0 0 5px rgba(185, 151, 43, 0.5); 
                    background-color: var(--dark-color-alt); /* Fondo del input al hacer focus */
                }
                
                .grupo-componente .porcentaje-wrapper {
                    position: relative;
                    flex-grow: 0;
                    max-width: 100px; /* Reducimos ligeramente el ancho para centrarlo */
                }
                .grupo-componente .porcentaje-wrapper::after {
                    content: '%';
                    right: 10px; /* Ajustamos la posición del % */
                    color: #666;
                }
                .grupo-componente .criterio-form input[type="number"] {
                    padding-right: 30px;
                    text-align: right; /* Alineamos el número a la derecha */
                }
                /* MEJORA 4: Botón Añadir */
                .grupo-componente .criterio-form .btn {
                    padding: 12px 15px; 
                    font-weight: 600; /* Hacemos el texto un poco más ligero */
                    border-radius: 6px;
                    white-space: nowrap;
                }
                /* MEJORA 5: Botones de Guardar/Cancelar al final del modal */
                ...
                .grupo-componente .modal-actions .btn-primary {
                    transform: none; /* Quitamos la animación de subir en el hover, solo en la lista de grupos */
                }

                .grupo-componente .criterio-total {
                    text-align: right; font-size: 1.2rem; font-weight: bold; /* Reducimos ligeramente la fuente */
...
                                style={{
                                    /* Estilos removidos aquí, ahora vienen del CSS global para .criterio-item button */
                                }}
                            >
