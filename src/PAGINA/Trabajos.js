...
        }
        
        /* MODIFICACIÓN 1: Estilos para el contenedor de los botones Criterios y Cerrar */
        .grupo-componente .main-header .header-actions {
            display: flex;
            gap: 10px; /* Espacio entre Criterios y Cerrar */
            /* Añadido un margen a la derecha para empujar al borde del contenedor del modal */
            margin-right: 20px; 
        }

        /* MODIFICACIÓN 2: Estilos para el contenedor de los botones de bimestre */
        .grupo-componente .bimestre-selector {
            display: flex;
            gap: 15px; /* Separación entre los botones de bimestre */
            margin-bottom: 2rem;
            padding: 0 20px;
        }
        
...
                    
                    {/* MODIFICACIÓN 1: Contenedor para alinear los botones a la derecha (extremo) */}
...
                </header>
                
                {/* MODIFICACIÓN 2: Contenedor de botones de bimestre ahora usa la clase con 'gap' */}
