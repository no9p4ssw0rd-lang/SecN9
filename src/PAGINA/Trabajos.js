...
  useEffect(() => {
    if (mensaje) {
      // La notificación dura 3 segundos antes de que se llame a onClose
...
  // Las clases 'notificacion-flotante', 'exito', 'error' y la animación @keyframes fadeInOut
  // DEBEN estar definidas en el CSS inyectado o en Trabajos.css.
...
        }
        ...
        .notificacion-flotante {
            ...
            opacity: 0;
            visibility: hidden;
            /* La animación total es 3.5s, sincronizada con el setTimeout de 3s */
...
            width: 100%; height: 100%;
            display: flex; /* Asegura el centrado del contenido del modal */
