...
function Home({ user }) {
  ...
  const materias = [
    "ESPAÑOL","ESPAÑOL II","ESPAÑOL III","INGLES","INGLES II", "INGLES III","ARTES","ARTES II","ARTES III",
    "MATEMATICAS","MATEMATICAS II","MATEMATICAS III","BIOLOGIA","BIOLOGIA II","BIOLOGIA III","GEOGRAFIA","GEOGRAFIA II","GEOGRAFIA III"
    ,"HISTORIA", "HISTORIA II","HISTORIA III", "FORMACION CIVICA Y ETICA" , "FORMACION CIVICA Y ETICA II", "FORMACION CIVICA Y ETICA III",
    "TECNOLOGIA","TECNOLOGIA II", " TECNOLOGIA III","EDUCACION FISICA","INTEGRACION CURRICULAR", "INTEGRACION CURRICULAR II", "INTEGRACION CURRICULAR III"
    ,"TUTORIA","TUTORIA II","TUTORIA III","QUIMICA","QUIMICA II","QUIMICA III","FISICA", "FISICA II", "FISICA III",
  ];
